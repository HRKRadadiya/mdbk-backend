...
import { MemberTokenPayload, UserTokenPayload } from '../types';
...
export default class TokenService {
	...
	*/
	 ...
	 * @returns {Promise<any>}
	 */
	public generateAdminAccessToken = (user: UserOutput): Promise<any> => {
		return new Promise((resolve, reject) => {
			const accessTokenExpires = moment().add(config.jwt.accessExpirationMinutes, 'minutes');
	 ...
	 * @param {MemberOutput} user
	 * @returns {Promise<any>}
	 */
	public generateMemberAccessToken = (member: MemberOutput): Promise<any> => {
		return new Promise((resolve, reject) => {
			const accessTokenExpires = moment().add(config.jwt.accessExpirationMinutes, 'minutes');
